...
| File | Description |
|---|---|
| `Task1_API/test_qwen_api.py` | Minimal script for Qwen-Plus API connectivity testing |
| `Task1_API/extract_pdf_text.py` | Python script for extracting text from the case report PDF |
| `Task1_API/extract_case_entities.py` | Python script for LLM-based medical entity extraction |
| `Task1_API/results/case_report_text.txt` | Extracted raw text from the case report |
| `Task1_API/results/case_entities.json` | Standardized JSON output of extracted medical entities |
...
| File | Description |
|---|---|
| `Task3_Guide/Medical_AI_Beginner_Guide.md` | Markdown source guide |
| `Task3_Guide/Medical_AI_Beginner_Guide.pdf` | Exported PDF version of the guide |
...
[ ] Task1_API/ with Python source files and JSON output
[ ] Task2_Paper/ with notebook, LaTeX source, figures, result files, and PDF paper
[ ] Task3_Guide/ with Markdown guide and exported PDF
